...
class User(db.Model):
    ...
    #added by Bryan - basic profile info
    profile_url = db.StringProperty(required=True)
    profile_image_url = db.StringProperty()
    
    #added by Bryan from sample GAE simple example
    access_token = db.StringProperty(required=True) #can't require yet
    access_token_expires = db.DateTimeProperty() #can't require yet
